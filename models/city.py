...
The `City` class extends from `BaseModel`, inheriting common attributes and
methods.
...
class City(BaseModel):
    ...
    This class inherits from `BaseModel` and adds specific attributes related
    to cities.

    Attributes:
        name (str): The name of the city.
        state_id (str): The unique identifier of the state to which the city
                        belongs.
    """
    ...
    def __init__(self, *args, **kwargs):
        ...
        Additional city-specific attributes are set from keyword arguments
        (kwargs) if provided.
